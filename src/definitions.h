...
/* Enumeration types. */
typedef enum { UNSPECIFIED, NIX_FILE, DOS_FILE, MAC_FILE } format_type;
...
typedef enum { OVERWRITE, APPEND, PREPEND } kind_of_writing_type;

typedef enum { CENTERING, FLOWING, STATIONARY } update_type;
